...
私たちが Bonfida に投資した理由を理解するには、まず Serum の優位性を理解することが大切です。Serum は、以下のような DEX ならではの特徴を備えています：

*   中央の取引所という仲介者が存在しないピアツーピアの構造。
*   ピアツーピア構造であることから一般に手数料が安い。
*   DEX は資産の預託が必要ないので、自分の暗号資産を第三者に預けることなく取引が可能で、望むならプラットフォームを安全に利用するためにハードウェアウォレットも使用できる。
*   完全に分散化された透明性のあるオーダーブック。
...
Bonfida は Serum DEX に、取引 BOT ／NFT の取引／洗練された GUI ／ウォレットといった、中央集権型取引所のすべての機能を移植することを目指しています。

![](https://miro.medium.com/max/1400/1*LxT1N1SeZnf4vhD_fGSjDQ.png)
><em>Bonfida 経由で表示した Serum の分散型オーダーブック</em>

最近実装されたものを挙げると:

*   取引履歴、成行注文やオンチェーンの Serum のデータを利用した TradingView チャート。
*   カスタマーサポートを提供するヘルプセンターの開発。
*   流動性を確保するためのマーケットメイカーとの連携。
*   FTX のレバレッジトークンを Bonfida を通じて Serum で独占提供。

<img alt="" class="fe en ej ku w" src="https://miro.medium.com/max/317/1*QVlRzB3j7mZToH1Vk4Dm5A.png" width="317" height="677" />

><em>Bonfida 経由で見た Serum の FTX BULL レバレッジトークン</em>

<img alt="" class="fe en ej ku w" src="https://miro.medium.com/max/2400/1*4wq7pL4FCYEkUIqoDCofXg.jpeg" width="700" height="382" />
...
Bonfida のネイティブトークン FIDA はプラットフォームに完全に統合されており、Bonfida 上の手数料に関するガバナンスコントロールを行います。FIDA は、以下の製品とサービスを通じて、その価値を生み出していきます：

*   **Bonfida Serum GUI**: Bonfida DEX は、チャートやウォレットなどの最適な機能とエクスペリエンスを提供することで、Serum の利用を拡大していきます。
*   **Bonfida Serum API**: 現在 API を利用しているユーザには、Coingecko や Coinmarketcap およびこの分野の最大手のマーケットメイカーもいます。ここでの目的は、DEX の特徴と機能を維持しつつ、規模を拡大し、中央集権型取引所のようなエクスペリエンスをユーザに提供することです。
*   **Serum ダッシュボード**: Serum の GUI／スワップ／貸借／ステーキングなどをすべて一カ所に集約します。
*   **Bonfida 取引 BOT**: オンチェーンの Serum 向け取引 BOT です。Serum に完全な機能を提供するという目標に向けて、チームは Bonfida BOT を開発しました。ユーザはテクニカル指標を用いて完全に取引を自動化するオンチェーンの取引 BOT を作成することができます。さらに、ユーザが自らの戦略をサブスクリプション販売して FIDA を報酬として受け取れるので、ネイティブトークンに新たな価値が生まれます。
*   **Solible**: Serum と Solana 上に構築された NFT 取引所です。Bonfida チームは Solible ([https://solible.com](https://t.co/lLdiy9m7YV?amp=1)) を開発することで、 NFT を革新的な形で採用し、NFT の分散型の取引を可能にしています。

<img alt="" class="fe en ej ku w" src="https://miro.medium.com/max/2400/1*ES6sy3tGdrsdWAM1Kv5Ulg.jpeg" width="700" height="397" />
